...
export const createCheckoutData = (order, shipping, shipToDifferentAddress) => {
    const checkoutData = {
        clientMutationId: v4(),

        billing: {
            firstName: shipToDifferentAddress ? order.firstName : shipping.firstName,
            lastName: shipToDifferentAddress ? order.lastName : shipping.lastName,
            address1: shipToDifferentAddress ? order.address1 :  shipping.address1,
            address2: shipToDifferentAddress ? order.address2 : shipping.address2,
            city: shipToDifferentAddress ? order.city : shipping.city,
            country: shipToDifferentAddress ? order.country : shipping.country,
            state: shipToDifferentAddress ? order.state : shipping.state,
            postcode: shipToDifferentAddress ? order.postcode : shipping.postcode,
            email: shipToDifferentAddress ? order.email : shipping.email,
            phone: shipToDifferentAddress ? order.phone : shipping.phone,
            company: shipToDifferentAddress ? order.company : shipping.company,
        },
        shipping: {
        ...
        isPaid: false,
        transactionId: "fewfwefwefwefewfwef"
    };

    return checkoutData;
};

export const createCustomerUpdateData = (order) => {
    const customerData = {
        clientMutationId: v4(),
        shipping: {
...
export const createCustomerUpdateDataGeneral = (order) => {
    const customerData = {
        clientMutationId: v4(),
        firstName: order.firstName,
        lastName: order.lastName,
...
export const createCustomerUpdateDataBilling = (order) => {
    const customerData = {
        clientMutationId: v4(),
        billing: {
            firstName: order.firstName,
...
export const createCustomerUpdateDataBillingAsShipping = (order) => {
    const customerData = {
        clientMutationId: v4(),
        shipping: {
            firstName: order.firstName,
