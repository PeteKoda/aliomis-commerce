...
const validateAndSanitizeBillingForm = ( data ) => {
    ...
    addErrorAndSanitizedData( 'shippingMethod', 'Shipping Method', 2, 254, 'string', true );
...
export default validateAndSanitizeBillingForm;
